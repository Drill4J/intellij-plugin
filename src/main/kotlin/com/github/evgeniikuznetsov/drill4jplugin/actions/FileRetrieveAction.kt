...
class FileRetrieveAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val socketFileRetriever = UrlFileRetriever(remotePath, saveDir)
        ...
        ProgressManager.getInstance().run(object : Task.Backgroundable(project, "Download file") {
            ...
            override fun onFinished() {
                ...
                val coverageRunner = CoverageRunner.EP_NAME.extensionList.find { StringUtils.equals(it?.dataFileExtension, "exec") }
